...
import type { BotProps } from 'hubility-chat'
...
declare global {
  namespace JSX {
    interface IntrinsicElements {
      'hubility-fullchatbot': React.DetailedHTMLProps<
...
export const FullPageChat = ({ style, className, ...assignableProps }: Props) => {
  ...
  useEffect(() => {
    ;(async () => {
      await import('hubility-chat/dist/web')
    })()
  }, [])
  ...
  return <hubility-fullchatbot ref={ref} style={style} class={className} />
}
